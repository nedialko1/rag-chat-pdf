...
# FIX: Explicitly using the full model tag 'tinyllama:1.1b' to resolve the 404 'not found' error.
...
try:
    ...
    # Updated warning to reflect the new, corrected model name
    print(
        f"WARNING: Could not complete LLM warm-up. Ensure Ollama is running and 'tinyllama:1.1b' is pulled. Error: {e}")
