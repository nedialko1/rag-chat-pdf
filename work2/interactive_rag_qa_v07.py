...
try:
    ...
    # Updated warning to reflect the corrected model name
    print(f"WARNING: Could not complete LLM warm-up. Ensure Ollama is running and 'llama3.2:3b' is pulled. Error: {e}")
