...
# CHANGED MODEL TO PHI3:MINI for much faster cold-start performance
...
try:
    ...
    print(f"WARNING: Could not complete LLM warm-up. Ensure Ollama is running and 'phi3:mini' is pulled. Error: {e}")
