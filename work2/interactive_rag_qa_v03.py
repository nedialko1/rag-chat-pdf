...
# RESTORING TO A MORE RELIABLE, LESS STRICT PROMPT for better synthesis
prompt = ChatPromptTemplate.from_template("""
    Answer the user's question based *only* on the provided context. 
    If you cannot find the answer in the context, clearly state that the information is not available in the document.
...
print("Warming up Ollama model and RAG chain (this may take 30-60 seconds on the first run)...")
# Run a dummy query through the ENTIRE chain to force all LLM and Chroma components to load.
DUMMY_QUERY = "What is the primary content of this document?"
try:
    ...
    print(f"WARNING: Could not complete LLM warm-up. Ensure Ollama is running. Error: {e}")
