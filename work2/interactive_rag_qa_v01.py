...
# UPDATED: Increased 'k' from 3 to 5 to retrieve more context and improve robustness
...
# UPDATED: Refined the prompt to encourage extraction of explicit data.
prompt = ChatPromptTemplate.from_template("""
    You are an accurate data extraction and summarization assistant. 
    Analyze the provided context and directly answer the user's question by extracting or synthesizing information from the context.
    If the answer is not explicitly present in the context, clearly state: "The specific answer could not be found in the provided document context."
